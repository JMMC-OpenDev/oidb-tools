...
# Define common paths and root urls
...
XML_GRANULES_FILE=$MIRROR_ROOT/granules.xml
ENV_GRANULES_FILE=$MIRROR_ROOT/granules.env # hardcoded and generated by splitGranule.xsl
